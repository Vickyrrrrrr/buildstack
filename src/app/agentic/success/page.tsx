...
const nextSteps = [
  "Download and install AgentIC Desktop for your operating system.",
  "Configure your BYOK model provider (OpenAI, Anthropic, Gemini, or a local model).",
  "Start your local workspace run.",
] as const;export default async function AgentICSuccessPage() {
  return (
              ...
              <div className="circuit-tile relative p-6 md:p-10">
                <div className="mx-auto max-w-2xl space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    <h1 className="section-title">You&apos;re all set to start building.</h1>
                    <p className="body-copy text-lg">
                      Download the desktop app below to begin designing locally.
                    </p>
                  </div>
                  <OpenDesktopButton />
